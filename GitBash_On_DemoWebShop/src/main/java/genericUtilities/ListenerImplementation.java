...
public class ListenerImplementation extends BaseTest implements ITestListener,ISuiteListener {
	...
	public void onStart(ISuite suite) {
	    ...
	    esreport= new ExtentSparkReporter("./advanceReport/"+suite.getName()+ju.getSystemDate()+".html");
		esreport.config().setDocumentTitle("DemoWebShop Report");
		esreport.config().setReportName(suite.getName()+ju.generateRandomNumber());
	  }
